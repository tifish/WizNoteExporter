...
namespace WizNoteExporter
{
    internal class Exporter
    {
        ...
        {
            [Column(Name = "DOCUMENT_GUID")] public string GUID { get; set; }

            [Column(Name = "DOCUMENT_TITLE")] public string Title { get; set; }

            [Column(Name = "DOCUMENT_LOCATION")] public string Location { get; set; }

            [Column(Name = "DOCUMENT_NAME")] public string FileName { get; set; }

            [Column(Name = "DT_DATA_MODIFIED")] public string ModifiedTime { get; set; }

            [Column(Name = "WIZ_DOWNLOADED")] public int Downloaded { get; set; }
        }

        [Table(Name = "WIZ_DOCUMENT_ATTACHMENT")]
        private class WizAttachment
        {
            [Column(Name = "DOCUMENT_GUID")] public string DocumentGUID { get; set; }

            [Column(Name = "ATTACHMENT_NAME")] public string FileName { get; set; }
        }
        ...
        private string[] _sourceCodeExtensions =
        {
            ".pas", ".dpr",
            ".vbs", ".vb",
            ".bat", ".cmd", ".sh", ".ps1",
        ...
        private string _outputTitlePath;
        private string _outputDir;
        private ExportFormat _exportFormat;
        private string _ziwFile;
